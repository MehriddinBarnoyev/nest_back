...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'UZS', default: 'UZS', required: false }),
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreateInvoiceDto.prototype, "accessDurationDays", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Thank you for your request', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
