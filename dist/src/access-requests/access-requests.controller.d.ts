...
export declare class AccessRequestsController {
    ...
    findForOwner(ownerUserId: string, userRole: UserRole, status?: AccessRequestStatus, courseId?: string, q?: string, dateFrom?: string, dateTo?: string, page?: number, limit?: number): Promise<{
        results: ({
            user: {
                email: string;
